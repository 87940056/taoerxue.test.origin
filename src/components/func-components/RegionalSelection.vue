<template>
  <section class="regional-selection" @click="setStatus(false)">
    <section class="func-area" @click.stop="">
      <section class="title">
        <span></span>
        <h4>所在地区</h4>
        <span @click="setStatus(false)">×</span>
      </section>
...
<script>
  import "../../assets/style/func-components/regional-selection.scss";
  export default{
